...
bool isaacNavigator::gotoTargetByAbsoluteLocation(yarp::dev::Map2DLocation loc)
{
...
bool isaacNavigator::getNavigationStatus(yarp::dev::NavigationStatusEnum& status)
{
...
bool isaacNavigator::getAbsoluteLocationOfCurrentTarget(yarp::dev::Map2DLocation& target)
{
...
bool isaacNavigator::getAllNavigationWaypoints(std::vector<yarp::dev::Map2DLocation>& waypoints)
{
...
* @return true/false
*/
bool isaacNavigator::getCurrentNavigationWaypoint(yarp::dev::Map2DLocation& curr_waypoint)
{
    yDebug() << "Not yet implemented";
    return false;
}

bool isaacNavigator::getCurrentNavigationMap(yarp::dev::NavigationMapTypeEnum map_type, yarp::dev::MapGrid2D& map)
{

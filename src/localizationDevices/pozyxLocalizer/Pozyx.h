...
typedef struct _UWB_settings {
    ...
    * See the reg:POZYX_UWB_RATES register for more information */
    uint8_t prf;
    /** The preamble length. Possible values are:
    *
    * - 0x0C : 4096 symbols.
    * - 0x28 : 2048 symbols.
    * - 0x18 : 1536 symbols.
...
public:
    ...
    *
    *   @param reg_address: the specific register address to start reading from
    *   @param pData: a pointer to the data that will be read
    *   @param size: the number of bytes to read
    ...
    *
    *   @param reg_address: the specific register address to start writing to
    *   @param pData: a pointer to the data that will be written
    *   @param size: the number of bytes to write
    *   @param remote_id: this is the network id of the remote Pozyx tag, if used.
    *
    * @retval #POZYX_SUCCESS success.
 ...
 */
    ...
    * When the system is reset the original network id is restored.
    *
 ...
 */
    ...
    * Function to retrieve the value of the given General Purpose Input/output pin (GPIO) on the target device
    *

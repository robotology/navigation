...
#ifndef DEV_EXTENDEDRANGEFINDER2DWRAPPER_H
#define DEV_EXTENDEDRANGEFINDER2DWRAPPER_H
...
private:
    ...
    yarp::os::BufferedPort<yarp::dev::LaserScan2D> streamingPortMod;
    ...
    std::string                                         rosTopicNameMod;               // name of the rosTopic
